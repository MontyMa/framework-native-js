<template>
  <div class="alert_view">
    <!--<div class="cont">-->
      <!--<div class="data_wrap">-->
        <!--<div class="total">成交总金额：<span>{{getTotalBanlance}}</span></div>-->
...
<!--<script>-->
  <!--export default{-->
    ...
    <!--computed: {-->
      <!--getTotalBanlance(){-->
        <!--let view_window = this.view_window,-->
          <!--total = 0;-->

        <!--view_window.forEach(elem => {-->
          <!--total += elem._alance;-->
        <!--});-->
    ...
    <!--},-->
    <!--mounted(){-->
      <!--console.log(this.view_window);-->
    <!--},-->
    <!--watch: {-->
      <!--cancel_status(val){-->
        <!--//console.log(val);-->
        <!--this.$emit('cancel_status', val)-->
      <!--}-->
    <!--}-->
  <!--}-->
<!--</script>-->
