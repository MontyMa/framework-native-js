<template>
	<div class="trading" id="trading">
		...
		<!--<ion-content>-->
			...
			<!--<div id="main" style="padding: 0px 15px;width: 1000px;height:600px;"></div>-->
		<!--</ion-content>-->
...
<!--<script>-->
	...
	<!--export default {-->
		...
		<!--computed: {-->
			...
			<!--},-->
			<!--rise_and_fall() {-->
				<!--return this.$store.getters.rise_and_fall;-->
			<!--}-->
		<!--},-->
		<!--data() {-->
			<!--return {-->
		...
		<!--mounted() {-->
			...
			<!--//获取深度-->
			<!--store.dispatch('send', [{channel: 'sub_spot_btc_cny_dailydata'}])-->
			...
			<!--var option = {-->
				...
				<!--tooltip: {-->
					...
					<!--formatter: function(a) {-->
						<!--//console.log(a[0]);-->
						<!--return '时间：' + a[0].name + '<br/>' + '开盘价：' + a[0].data[0] + '<br/>' + '最高价：' + a[0].data[0] + '<br/>' + '最低价：' + a[0].data[0] + '<br/>' + '收盘价：' + a[0].data[0] + '<br/>' + '交易量：' + a[0].data[0];-->
					<!--}-->
				<!--},-->
				<!--legend: {-->
					<!--//					data: ['KLine', 'MA5']-->
