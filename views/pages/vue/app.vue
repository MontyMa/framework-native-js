        ...
        data(){
            return {
                ...
                paging_option: {
                    ...
                    prevBtnTxt: 'hahah',        //上一页按钮字段:若为false，则不显示 必须为字符串类型；可选参数。
                    nextBtnTxt: 'heiehei',        //下一页按钮字段:若为false，则不显示 必须为字符串类型；可选参数。
                    first: 'nihao',           //控制首页。仅支持字符串类型。如：first: '首页',如果不传则默认为'1'
                    last: 'woshishei',            //控制尾页。值支持三种类型。如：last: '尾页',如果不传则默认为总页数
